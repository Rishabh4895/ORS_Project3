...
<body class="p1">
	<form action="<%=ORSView.SUBJECT_LIST_CTL%>" method="post">
		...
		<jsp:useBean id="dto" class="com.sunilOS.ORSProject3.dto.SubjectDTO"
		...
		<div>
				...
				<table>
					<tr>
						...
						<td><input type="submit" name="operation"
							value="<%=SubjectListCtl.OP_SEARCH%>" class="srpnbtn"></td>
						<td><input type="submit" name="operation"
							value="<%=SubjectListCtl.OP_RESET%>" class="srpnbtn"></td>
					</tr>
				</table>
					...
					<tbody>
						<tr style="background-color: white">
							...
							<td><button type="button" name="operation"
									value="<%=SubjectListCtl.OP_EDIT%>"
									onclick="location.href='SubjectCtl?id=<%=subjectDTO.getId()%>'"
			...
			<br> <br> <input type="submit" name="operation"
				value="<%=SubjectListCtl.OP_BACK%>" class="srpnbtn">
