...
<body class="p1">
	<form action="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>">
		...
		<center>
			...
			<a style="font-size: 16px; background-color: black; color: white;"
				href="/ORS_Project3/ctl/JasperCtl" class="btn" role="button"
				target="blank"> <span class="fa fa-print mr-1"></span>Print
			</a> <input type="hidden" name="pageNo" value="<%=pageNo%>"> <input
