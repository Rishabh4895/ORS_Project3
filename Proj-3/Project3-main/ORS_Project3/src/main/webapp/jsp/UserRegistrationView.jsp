...
<center>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-4 col-md-4 col-md-4 col-lg-6">
...
<%
				...
				%>
					...
					<%=ServletUtility.getSuccessMessage(request)%><button type="button" 
	...
	<input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(dto.getModifiedDatetime())%>">
		...
		<br>
         ...
         <span class="input-group-text"><i class="fa fa-user grey-text" style="font-size: 1rem;"></i></span>
          ...
          <input type="text" class="form-control" name="firstName" onchange = "capitalize(this)" 
          placeholder="Enter First Name" value="<%=DataUtility.getStringData(dto.getFirstName())%>">
        </div>
         	<font color="red" style="padding-right: 5cm; font-size: .4cm;">
        ...
        <div class="input-group">
            <div class="input-group-prepend">
             ...
             <input type="text" class="form-control" name="lastName" onchange = "capitalize(this)" 
        ...
        <div class="input-group">
            <div class="input-group-prepend">
                ...
                <%=DataUtility.getDateToString(dto.getDob())%>">
        </div>
         	<font color="red" style="padding-right: 6cm; font-size: .4cm;">
		...
		<br>
  		<div class="input-group">
            <div class="input-group-prepend">
           		...
           		<i class="fa fa-phone grey-text" style="font-size: 1rem;"></i></span>
            </div>
            ...
            value="<%=DataUtility.getStringData(dto.getMobileNo())%>">
         	...
         	<font color="red" style="padding-right: 5cm; font-size: .4cm;">
         	<%=ServletUtility.getErrorMessage("mobileNo", request)%></font>
        ...
        <div class="input-group">
            <div class="input-group-prepend">
           		<span class="input-group-text"><i class="fa fa-venus-mars grey-text"
			...
			<%=HTMLUtility.getList("gender", dto.getGender(), genMap, "Select Gender")%>
         	...
         	<%=ServletUtility.getErrorMessage("gender", request)%></font>
               ...
               <br>
                    ...
                    <input type="submit" class="btn btn-secondary" name="operation" 
