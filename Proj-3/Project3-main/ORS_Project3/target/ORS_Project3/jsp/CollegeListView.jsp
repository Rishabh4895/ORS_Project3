	...
	<form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="post">
		...
		<div>
				...
				<table>
					<tr>
						...
						<td><input type="submit" name="operation"
							value="<%=CollegeListCtl.OP_SEARCH%>" class="srpnbtn"></td>
						<td><input type="submit" name="operation"
							value="<%=CollegeListCtl.OP_RESET%>" class="srpnbtn"></td>
					</tr>
				</table>
					...
					<tbody>
						<tr style="background-color: white">
							...
							<td><button type="button" name="operation"
									value="<%=CollegeListCtl.OP_EDIT%>"
									onclick="location.href='CollegeCtl?id=<%=collegeDTO.getId()%>'"
			...
			<button
				...
				type="submit" name="operation" value="<%=CollegeListCtl.OP_DELETE%>"
			...
			<input style="margin-right: 6%; margin-left: 26%;" type="submit"
				name="operation" value="<%=CollegeListCtl.OP_NEW%>" class="srpnbtn">
			...
			<br> <br> <input type="submit" name="operation"
				value="<%=CollegeListCtl.OP_BACK%>" class="srpnbtn">
