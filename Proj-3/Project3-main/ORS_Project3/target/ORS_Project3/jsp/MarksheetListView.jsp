		...
		<div>
			<center>
				...
				<h2 style="text-shadow: #343a40;">
					<u><b>Marksheet List</b></u>
				</h2>
				<jsp:useBean id="dto"
					class="com.sunilOS.ORSProject3.dto.MarksheetDTO" scope="request"></jsp:useBean>
				...
				<table>
					<tr>
						<td><input type="text" name="rollNo" class="form-control"
							...
							placeholder="Enter Roll No." style="width: 5.5cm;"></td>
						<td><input type="text" name="name"
							value="<%=ServletUtility.getParameter("name", request)%>"
							placeholder="Enter Student Name" class="form-control"
							style="width: 5.5cm;"></td>
						<td><input type="submit" name="operation"
							value="<%=MarksheetListCtl.OP_SEARCH%>" class="srpnbtn"></td>
						<td><input type="submit" name="operation"
							value="<%=MarksheetListCtl.OP_RESET%>" class="srpnbtn"></td>
					</tr>
				</table>
					...
					%><tbody>
						<tr style="background-color: white">
							...
							<td><button type="button" name="operation"
									value="<%=MarksheetListCtl.OP_EDIT%>"
									onclick="location.href='MarksheetCtl?id=<%=marksheetDTO.getId()%>'"
			...
			<button
				...
				value="<%=MarksheetListCtl.OP_DELETE%>" class="fa fa-trash-alt btn"></button>

			<input type="submit" name="operation"
				value="<%=MarksheetListCtl.OP_PREVIOUS%>"
				<%=(pageNo > 1) ? "" : "disabled"%> class="srpnbtn"> <input
				type="submit" name="operation" value="<%=MarksheetListCtl.OP_NEXT%>"
			...
			<br> <br> <input type="submit" name="operation"
				value="<%=MarksheetListCtl.OP_BACK%>" class="srpnbtn">
